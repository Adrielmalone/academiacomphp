...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/06/2024 às 03:20
...
--
ALTER TABLE `atividades`
  ADD CONSTRAINT `atividades_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
